...
**Q: 数据库文件在哪里？**  
A: 默认在 `backend/instance/table_extractor.db`，如果从根目录运行可能在 `instance/table_extractor.db`

**Q: 如何备份数据？**  
A: 备份 `backend/instance/` 目录（数据库）和 `backend/uploads/` 目录（Excel文件）
